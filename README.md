...
            box-shadow: 0 0 15px rgba(255, 255, 255, 0.2);
            /* To make sure main photo fits in the circular slot */
            object-fit: cover; 
        }
        /* Gallery Image Styling to ensure photos fit entirely in the slot */
        .gallery-image {
            width: 100%;
            height: 100%; /* Ensures it fills the relative parent div */
            object-fit: cover; /* This ensures the image covers the entire area without being stretched, cropping if necessary */
            border-radius: 4px;
            aspect-ratio: 4/3; /* Set a consistent aspect ratio for the slots */
        }
        .card {
...
                   <img src="https://github.com/sushmitha-d-nitw/Dr.D.SUSHMITHA/main/website%20phototes/Image%201.jpg " alt="image 1" class="gallery-image">
...
                    </div>
                                        <div class="relative group">
                        <img src="https://github.com/sushmitha-d-nitw/Dr.D.SUSHMITHA/main/website%20phototes/Image%203.jpg " alt="image 3" class="gallery-image">
...
                    </div>
                                        <div class="relative group">
                        <img src="https://github.com/sushmitha-d-nitw/Dr.D.SUSHMITHA/main/website%20phototes/Image%205.jpg " alt="image 5" class="gallery-image">
                        <span class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-white text-xs p-2 text-center">Image 5 </span>
                    </div>
                                        <div class="relative group">
                        <img src="https://github.com/sushmitha-d-nitw/Dr.D.SUSHMITHA/main/website%20phototes/Image%206.jpg " alt="image 6" class="gallery-image">
                        <span class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-white text-xs p-2 text-center">Image 6 </span>
                    </div>
                                        <div class="relative group">
                        <img src="https://github.com/sushmitha-d-nitw/Dr.D.SUSHMITHA/main/website%20phototes/Image%207.jpg " alt="image 7" class="gallery-image">
...
    <script>
        // Rest of the JavaScript for navigation is included here to make the code complete
