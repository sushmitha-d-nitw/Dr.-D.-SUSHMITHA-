...
My core expertise is in <span style="color: #FFFF00;">Sustainable Technology</span>, advanced coatings, and process modeling using <span style="color: #FFFF00;">ASPEN</span> and <span style="color: #FFFF00;">ANSYS</span>.
            ...
            <section id="experience" class="content-section">
                <h2 class="text-2xl 
font-bold section-heading">Professional Experience (10 Years, 7 Months)</h2>
                <div class="grid md:grid-cols-2 gap-1">
                    <div class="card card-content">
                        <h3 class="text-sm font-semibold">Asst.
Professor (Temporary)</h3>
                        <span class="text-sm inline-block mr-2">Biotech, JNTU-H |
...
Executed <span style="color: #FFFF00;">Digital marketing</span>, <span style="color: #FFFF00;">HR/Payroll</span>. Acquired <span style="color: #FFFF00;">Leadership skills</span>.</span>
                    ...
                    <div class="card card-content">
                        <h3 class="text-sm font-semibold">Asst.
Professor & Coordinator</h3>
                        <span class="text-sm inline-block mr-2">Petrochemical Tech, Excel Engg College |
May - Nov 2022.</span>
...
Managed labs.</span>
                    ...
                    <div class="card card-content">
                        ...
                        <span class="text-sm inline-block">Focus: <span style="color: #FFFF00;">Improvement of Crude Benzol Production</span>.</span>
                        <span class="text-sm inline-block mr-2">KERBS, Indo American Pharma | <span style="color: #FFFF00;">2007</span>.</span>
            ...
            <section 
id="education" class="content-section">
                <h2 class="text-2xl font-bold section-heading">Educational Qualifications</h2>
                <div class="grid md:grid-cols-2 gap-1">
                    <div class="card card-content">
                        <h3 class="text-sm font-semibold">Ph.D.
in Chemical Engineering</h3>
                        <span class="text-sm inline-block mr-2">NIT Warangal |
Aug 2015 - Mar 2021.</span>
                        <span class="text-sm inline-block">Thesis: <span style="color: #FFFF00;">Acoustic Cavitation for Self-Healing Corrosion Inhibition Coatings</span>.</span>
                    </div>
                    <div class="card card-content">
                   
     <h3 class="text-sm font-semibold">M.Tech in Chemical Engineering (7.28 CGPA)</h3>
                        <span class="text-sm inline-block mr-2">NIT Warangal |
Jul 2009 - Jul 2011.</span>
                        <span class="text-sm inline-block">Specialization: <span style="color: #FFFF00;">Computer Aided Process Equipment Design</span>.
</span>
                    </div>
                    <div class="card card-content">
            ...
            <section id="publications" class="content-section">
              ...
              <div class="card card-content">
                        ...
                        <ul class="horizontal-list text-sm">
                            <li><span style="color: 
#FFFF00;">6</span> Journal Papers (incl. *Ultrasonication and Sonochemistry*, IF: <span style="color: #FFFF00;">9.336</span>)</li>
                    ...
                    <div class="card card-content">
                        ...
                        <ul class="horizontal-list text-sm">
                         ...
                         <li><span style="color: #FFFF00;">Best Paper Award</span> (Research Conclave-17)</li>
                            ...
                            <li>Memberships: Associate Member of <span style="color: 
#FFFF00;">IICHE</span> and <span style="color: #FFFF00;">IEI</span></li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section id="detailed-publications" class="content-section">
                <h2 class="text-2xl font-bold section-heading">Detailed Publications, Conferences & Workshops</h2>
                <div class="grid md:grid-cols-1 gap-1">
                    <div class="card card-content">
                        ...
                        <ul class="text-sm list-disc pl-5">
                            <li><span style="color: #E0E0E0;">**Please add your 6 publications here, including Journal Name, Indexing, and Link to the original paper.**</span></li>
                            <li><span style="color: #E0E0E0;">**Example:** Title of Paper (Year), *Journal Name*, Indexed (Scopus/WoS), <a href="#" target="_blank">Original Paper Link</a>.</li>
                        </ul>
                    </div>
                    <div class="card card-content">
                        <h3 class="text-sm font-semibold">International Conferences (<span style="color: #FFFF00;">15</span>)</h3>
                        <span class="text-sm"><span style="color: #E0E0E0;">**Please list your International Conference papers here.**</span></span>
                    </div>
                    <div class="card card-content">
                        <h3 class="text-sm font-semibold">National Conferences (<span style="color: #FFFF00;">4</span>)</h3>
                        <span class="text-sm"><span style="color: #E0E0E0;">**Please list your National Conference papers here.**</span></span>
                    </div>
                </div>
            </section>
                ...
                <div class="grid md:grid-cols-2 gap-1">
                 ...
                 <span class="text-sm"><span style="color: #FFFF00;">ASPEN plus, ASPEN tasc+, ASPEN Hysis</span>, ANSYS (3D Modeling), CRM Software.</span>
                     ...
                     <div class="card card-content">
                        ...
                        <span class="text-sm">Techniques for identifying molecular structure and quantifying concentration.</span>
                        <ul class="text-sm list-disc pl-5 mt-1">
                            <li><span style="color: #FFFF00;">Infrared (IR) & Raman Spectroscopy</span>: Molecular identification, structural analysis.</li>
                            <li><span style="color: #FFFF00;">Nuclear Magnetic Resonance (NMR)</span>: Determining molecular structure, purity, and concentration.</li>
                            <li><span style="color: #FFFF00;">UV-Visible Spectrometry (UV-Vis)</span>: Quantitative analysis and concentration determination.</li>
                            <li><span style="color: #FFFF00;">Mass Spectrometry (MS)</span>: Identifying unknown compounds, molecular weight determination.</li>
                            <li><span style="color: #FFFF00;">HPLC, TGA, Particle Size Analyser</span>: Separation, thermal stability, and size distribution.</li>
                        </ul>
                    </div>
                    <div class="card card-content">
...
Techniques</h3>
     ...
     <h3 class="text-sm font-semibold">Awards & Participation</h3>
        ...
        <span class="text-sm inline-block">Won <span style="color: #FFFF00;">merit prize</span> in "Hindi Talent Test".</span>
             ...
             <span class="text-sm inline-block mr-2">Participated in Intl.
Symposiums <span style="color: #FFFF00;">"FUSION-05" & "SCHEMCON-06"</span>.</span>
...
& References</h2>
                <div class="grid md:grid-cols-2 gap-1">
                    <div class="card card-content">
                        ...
                        <span class="text-sm inline-block mr-2">Phone: <span style="color: #FFFF00;">7981541047 
/ 6304608610</span>.</span>
...
<a href="mailto:sushmitha.d.nitw@gmail.com">sushmitha.d.nitw@gmail.com</a></span>
                    ...
                    <div class="card card-content">
                        ...
                        <span class="text-sm inline-block mr-2"><span style="color: 
#FFFF00;">Google Scholar</span>: <a href="https://scholar.google.com/citations?user=Qk1uTQYAAAAJ" target="_blank">View Profile</a>.</span>
        ...
        <div class="card card-content md:col-span-2">
                        ...
                        <span class="text-sm inline-block mr-2">Dr.
S. Srinath (Assoc. Prof & Head, NIT-W) | Dr. Shirish Hari Sonawane (Prof, NIT-W) |
